...
namespace LazyAbp.Abp.AuthCenter.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AuthCenterDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AuthCenterEfCoreEntityExtensionMappings to extend the IdentityUser entity
