...
namespace LazyAbp.Abp.AuthCenter.Web.Menus
{
    public class AuthCenterMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public AuthCenterMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<AuthCenterResource>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("AuthCenter.Home", l["Menu:Home"], "~/"));
